...
4. **Live Burp bridge** -Pull traffic straight from a running Burp Suite over the loopback bridge (see [Using Vigolium with Burp Suite](/getting-started/burp-suite))
