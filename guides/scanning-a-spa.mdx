...
For environments where auto-download is not possible (air-gapped systems, containers), pre-install Chromium and point Vigolium to it via the `browser.executable_path` config option.
