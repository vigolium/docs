...
This is particularly effective in CI because the source code is always present in the checkout directory. See the [Whitebox Scanning guide](/guides/whitebox-scanning) for more details.
