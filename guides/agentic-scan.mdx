...
description: "Use AI-driven scanning modes — Query, Swarm, Autopilot, and Archon — to autonomously discover, audit, and verify vulnerabilities."
icon: "brain"
---
...
See [Archon Audit](/agentic-scan/archon-audit) for the full guide.
...
| **Archon** | Multi-phase | Whitebox source-code audit (standalone or alongside swarm/autopilot) |
