...
vigolium agent vigolium-audit --source ./app --mode deep

# Lite mode (CI-friendly, 3 phases)
vigolium agent vigolium-audit --source ./app --mode lite

# Use a different agent CLI
vigolium agent vigolium-audit --source ./app --mode balanced --agent codex
```
