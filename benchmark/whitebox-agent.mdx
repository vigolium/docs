---
title: "Whitebox Agent Benchmark Suite"
description: "Describes the whitebox agent benchmark suite for validating Vigolium's AI agent pipeline."
icon: "flask-vial"
---
...
2. **One fixture per (stub x template) pair**: Each fixture captures the raw output from running a specific prompt template against a specific source code stub.
...
For each (stub x template) pair in the matrix:
