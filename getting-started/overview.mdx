...
Deterministic, multi-phase vulnerability scanning via `vigolium scan`. Fast, modular, and repeatable — runs content discovery, browser spidering, SPA crawling, SAST, and active/passive audit phases with **215 scanner modules** (130 active, 85 passive).
...
- **Source code awareness** — link repos to hostnames for source-aware scanning with SAST integration
