...
| **Archon** | `vigolium agent archon` | Multi-phase whitebox security audit (lite / balanced / deep). Embedded driver — no extra install. Runs as a foreground audit or in the background alongside swarm/autopilot. |
...
| Audit source code in depth | [Archon Audit](/agentic-scan/archon-audit) — or [Piolium Audit](/agentic-scan/piolium-audit) |
