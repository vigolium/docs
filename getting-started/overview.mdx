...
<Frame caption="Discovery (Deparos)">
  <img src="/images/vigolium-native-scan.png" alt="Discovery" />
</Frame>
<Frame caption="Spidering (Spitolas)">
