...
See [Agent Mode](/agentic-scan/agent-mode) for the full agent documentation (autopilot, swarm, vigolium-audit, query, olium) and the [API Reference](/api-references/agent) for request/response details.
