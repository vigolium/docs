...
- **[Vigolium Audit](https://www.npmjs.com/package/@vigolium/vigolium-audit)** — embedded driver that runs through the `claude` CLI (Claude / Codex). Up to 11 phases at `deep`. No extra install.
