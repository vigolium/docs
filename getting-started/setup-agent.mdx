...
|---|---|---|---|
| `openai-compatible` *(default)* | optional `api_key` | `gemma4:latest` (via `custom_provider.model_id`) | Ollama, OpenRouter, LM Studio, vLLM, … |
