...
description: "Reference for Vigolium's 251 scanner modules, 154 active and 97 passive, covering the OWASP Top 10 and beyond."
icon: "cubes"
---

Vigolium ships with **251 scanner modules**, 154 active and 97 passive, covering the OWASP Top 10 and beyond. Run `vigolium module ls` for the up-to-date enabled list (the registry can grow between releases without a docs refresh).
