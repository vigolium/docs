...
description: "Reference for Vigolium's 324 scanner modules, 207 active and 117 passive, covering the OWASP Top 10 and beyond."
icon: "cubes"
---

Vigolium ships with **324 scanner modules**, 207 active and 117 passive, covering the OWASP Top 10 and beyond. Run `vigolium module ls` for the up-to-date enabled list (the registry can grow between releases without a docs refresh).
