...
- [Blackbox Scanning](/native-scan/blackbox-scan) — Dynamic scanning without source code
- [Extension Scanning](/native-scan/extension-scan) — Custom JS/YAML extension modules
- [Whitebox Scanning](/native-scan/whitebox-scan) — Static analysis with source code
- [Whitebox + Agent Scanning](/native-scan/whitebox-agent-scan) — AI-enhanced source code analysis
- [Full Combined Scan](/native-scan/full-scan) — Maximum coverage with all capabilities
