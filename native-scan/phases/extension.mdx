---
title: "Extension Scanning"
description: "Run custom JavaScript or YAML extension modules against targets, alongside or instead of built-in scanner modules."
icon: "puzzle-piece"
---
...
- [Writing Extensions](/customization/writing-extensions) — Full guide to writing JS and YAML extensions
- [Extension API Reference](/api-references/extensions) — Complete `vigolium.*` API surface
