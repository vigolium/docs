---
title: "SPA -- Single Page Application Scanning"
description: "Extends browser-based crawling with specific handling for JavaScript-heavy SPAs where traditional crawling fails."
