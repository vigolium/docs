...
| **Piolium** | `vigolium agent piolium` | Pi-native whitebox audit driver (separate install). Up to 17 phases at `deep`, the most thorough audit available. |
...
<Columns cols={2}>
  <Frame caption="CLI Native Scan">
    <img src="/images/vigolium-cli-native-scan.png" alt="CLI Native Scan" />
  </Frame>

  <Frame caption="CLI Native Scan 2">
    <img src="/images/vigolium-cli-native-scan-2.png" alt="CLI Native Scan 2" />
  </Frame>
</Columns>
