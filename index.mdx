...
<Frame caption="Vigolium Workbench Dashboard">
  <img src="/images/vigolium-ui-dashboard-1.png" alt="UI Dashboard 1" />
</Frame>
...
<Columns cols={2}>
  <Frame caption="UI Dashboard">
    <img src="/images/vigolium-ui-dashboard-1.png" alt="UI Dashboard 1" />
  </Frame>
  <Frame caption="UI Dashboard">
    <img src="/images/vigolium-ui-dashboard-2.png" alt="UI Dashboard 2" />
  </Frame>
  <Frame caption="UI Dashboard">
    <img src="/images/vigolium-ui-dashboard-3.png" alt="UI Dashboard 3" />
  </Frame>
  <Frame caption="UI Dashboard">
    <img src="/images/vigolium-ui-dashboard-4.png" alt="UI Dashboard 4" />
  </Frame>
</Columns>
...
See [the full overview](/overview) and [strategies](/native-scan/strategies) for strategies, profiles, and pace configuration.
...
| Output & Reporting | [Output & Reporting](/output-and-reporting) |
| Troubleshooting | [Troubleshooting](/troubleshooting) |
| Scanning Modes Overview | [Scanning Modes](/native-scan/scanning-modes-overview) |
| Scanning Strategies | [Strategies](/native-scan/strategies) |
| Authenticated Scanning | [Authentication](/native-scan/authentication) |
| Content Discovery (Deparos) | [Discovery](/native-scan/phases/discovery) |
| Browser Spider (Spitolas) | [Spidering](/native-scan/phases/spidering) |
| SPA Scanning | [SPA](/native-scan/phases/spa) |
| Audit | [Audit](/native-scan/phases/audit) |
| Scanner Modules Reference | [Modules Reference](/native-scan/modules-reference) |
| Agent Mode | [Agent Mode](/agentic-scan/agent-mode) |
| Agentic Scan: How It Works | [How It Works](/agentic-scan/how-it-works) |
| Autopilot | [Autopilot](/agentic-scan/autopilot) |
| Swarm | [Swarm](/agentic-scan/swarm) |
| Query Mode | [Query](/agentic-scan/query) |
| Server Mode | [Running the Server](/server-mode/running-the-server) |
| Ingestion | [Ingestion](/server-mode/ingestion) |
| REST API Reference | [API Overview](/api-overview) |
| Writing Extensions | [Writing Extensions](/customization/writing-extensions) |
| Extending Vigolium | [Extending Vigolium](/customization/extending-vigolium) |
| Whitebox Scanning | [Whitebox Scanning](/guides/whitebox-scanning) |
| CI/CD Integration | [CI/CD Integration](/guides/ci-cd-integration) |
