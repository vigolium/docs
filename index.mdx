...
| **Vigolium Audit** | `vigolium agent vigolium-audit` | Multi-phase whitebox security audit (lite / balanced / deep). Runs as a foreground audit driver or in the background alongside swarm/autopilot. |
