...
|-------|-------------|------|
| **Overview** | Architecture, scanning paradigms, and reading guide | [Overview](/getting-started/overview) |
| **Getting Started** | Install, run your first scan, and understand results | [Getting Started](/getting-started/getting-started) |
| **Configuration** | Layered config system, profiles, and environment variables | [Configuration](/getting-started/configuration) |
| **Scanning Modes** | Compare all native scanning modes and strategies | [Scanning Modes](/native-scan/scanning-modes-overview) |
| **Strategies** | Lite, balanced, deep, and whitebox presets | [Strategies](/native-scan/strategies) |
| **Authentication** | Multi-session auth, IDOR testing, and login flows | [Authentication](/native-scan/authentication) |
| **Discovery (Deparos)** | Adaptive content discovery with soft-404 detection | [Discovery](/native-scan/phases/discovery) |
| **Spidering (Spitolas)** | Browser-based Chromium crawler with CDP capture | [Spidering](/native-scan/phases/spidering) |
| **Audit** | Active/passive vulnerability scanning with 215 modules | [Audit](/native-scan/phases/audit) |
| **Agent Mode** | AI-powered scanning with autonomous agents | [Agent Mode](/agentic-scan/agent-mode) |
| **Autopilot** | Autonomous AI-driven vulnerability scanning | [Autopilot](/agentic-scan/autopilot) |
| **Swarm** | AI-guided targeted or full-scope scanning | [Swarm](/agentic-scan/swarm) |
| **Server Mode** | REST API server with Swagger UI and traffic ingestion | [Server Mode](/server-mode/running-the-server) |
| **Output & Reporting** | Console, JSON, JSONL, and HTML report formats | [Output & Reporting](/getting-started/output-and-reporting) |
| **Writing Extensions** | Custom JS modules and hooks via embedded engine | [Writing Extensions](/customization/writing-extensions) |
| **Whitebox Scanning** | Source-aware scanning with route extraction and SAST | [Whitebox Scanning](/guides/whitebox-scanning) |
| **CI/CD Integration** | Integrate Vigolium into your CI/CD pipeline | [CI/CD Integration](/guides/ci-cd-integration) |
| **REST API Reference** | Full API documentation with Swagger UI | [REST API Reference](/api-overview) |
