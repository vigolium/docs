...
description: "Covers every customization mechanism in Vigolium, from JS and YAML extensions to scanning profiles and agent backends."
icon: "puzzle-piece"
---
...
- [7. Agent Backends](#7-agent-backends)
...
| [Agent Backends](#7-agent-backends) | Any (subprocess) | No | Plugging in new AI models or custom CLI tools |
...
| Plug in a new AI model | [Agent Backend](#7-agent-backends) |
