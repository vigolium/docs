...
description: "Guide to writing custom scanning extensions for Vigolium in JavaScript, YAML, quick checks, and snippets."
icon: "code"
---
...
| `run(opts)` | Run an inline olium agent turn (in-process; uses the same provider as `vigolium agent olium`) |
