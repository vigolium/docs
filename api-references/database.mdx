---
title: "Vigolium API Reference, Generic Database API"
description: "Unified CRUD API for any database table with pagination, filtering, sorting, and full-text search."
icon: "database"
---
