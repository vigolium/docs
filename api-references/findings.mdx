---
title: "Vigolium API Reference, Findings"
description: "List, retrieve, and delete vulnerability findings with filtering, pagination, and severity-based queries."
icon: "list"
---
...
| `finding_source` | string |            | Filter by finding source: `dynamic-assessment`, `known-issue-scan`, `agent`, `audit`, `oast`, `extension`, `import` |
