---
title: "Vigolium API Reference, Config"
description: "View and update server configuration using dot-notation keys with hot reload support."
icon: "gear"
---
...
Reloadable sections (scope, notify, dynamic-assessment, mutation_strategy) take effect immediately. Server and database changes require a restart.
...
**Reloadable sections:** `scope`, `notify`, `dynamic-assessment`, `mutation_strategy`
