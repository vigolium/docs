---
title: "Vigolium API Reference — OAST Interactions"
description: "List, retrieve, and delete out-of-band application security testing interactions from interactsh callbacks."
icon: "satellite-dish"
---
