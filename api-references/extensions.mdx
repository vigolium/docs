---
title: "Vigolium API Reference — Extensions"
description: "Manage JavaScript and YAML extensions that add custom scanning logic, including listing, editing, and API docs."
icon: "puzzle-piece"
---
