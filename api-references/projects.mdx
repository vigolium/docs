---
title: "Vigolium API Reference, Projects"
description: "Manage projects for multi-tenant data isolation. All scan data is scoped to a project via project_uuid."
icon: "folder-open"
---
...
| `stats.scans`             | int   | Total native scan sessions               |
| `stats.agentic_scans`     | int   | Total agentic scan runs (query/autopilot/swarm/audit) |
