...
Source code uploads for AI-driven analysis (swarm, autopilot, vigolium-audit) are handled via the cloud-storage API. See [Storage API](/api-references/storage):
