...
✦ Scan Configuration
  ...
  ℹ Speed: concurrency=50 | rate-limit=100 | max-per-host=30
  ℹ Modules: 207 active, 116 passive
```
...
```json
{
  ...
  "logs": [
    ...
    },
    {
      ...
      "metadata": "{\"project_uuid\":\"my-project-uuid\",\"targets\":[\"https://example.com\"],\"strategy\":\"balanced\",\"concurrency\":50,\"rate_limit\":100,\"max_per_host\":30,\"active_modules\":201,\"passive_modules\":116,\"spidering_enabled\":true,\"discovery_enabled\":true,\"known_issue_scan_enabled\":false}",
      "created_at": "2026-02-16T15:00:00Z"
    },
    {
      "id": 3,
    ...
    },
    {
      ...
      "phase": "audit",
      "message": "phase started",
      "metadata": "{\"active_modules\":201,\"passive_modules\":116}",
