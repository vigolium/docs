...
**Skill repository:** [github.com/vigolium/skills](https://github.com/vigolium/skills)
...
**Custom limits (fewer commands, shorter wall-clock):**
```
> Limit the agent to 50 commands and 15 minutes
```
```bash
vigolium agent autopilot -t https://example.com --max-commands 50 --max-duration 15m
```
