---
title: "Agent Mode"
description: "Vigolium's agent mode integrates AI agents into the vulnerability scanning workflow with query, autopilot, and swarm modes."
icon: "robot"
---
...
See [How It Works](/agentic-scan/how-it-works) for detailed protocol comparison and backend reference.

## Further Reading

- [Autopilot](/agentic-scan/autopilot) — detailed flow, security sandbox, session pooling
- [Swarm](/agentic-scan/swarm) — input normalization, master agent prompt, extension generation, discovery mode, phase breakdown
