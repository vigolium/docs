---
title: "Olium Agent"
description: "The in-process AI agent runtime that powers every agentic feature in Vigolium — interactive TUI, headless prompts, and the engine library used by autopilot, swarm, query, and archon."
icon: "atom"
---
