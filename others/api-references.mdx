...
| Category | Description | Reference |
|----------|-------------|-----------|
| **Agent** | Query, autopilot, and swarm run modes with SSE streaming and OpenAI-compatible chat | [View →](/api-references/agent) |
...
| **Source Repos** | Link application source code to target hostnames for source-aware scanning | [View →](/api-references/source-repos) |
| **GitHub** | OAuth-based GitHub integration for repository browsing and cloning | [View →](/api-references/github) |
